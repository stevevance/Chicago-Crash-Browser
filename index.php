...
<div id="listContainer">
	<div id="list">
		...
		<p>Right-click on the map to get bike and pedestrian crash information for that point (wait a few seconds). Search radius is 150 feet. Very beta right now; <a href='https://github.com/stevevance/Chicago-Crash-Browser'>fork it on GitHub</a>. -<a href="mailto:steve@stevevance.net">Steven Vance</a></p>
